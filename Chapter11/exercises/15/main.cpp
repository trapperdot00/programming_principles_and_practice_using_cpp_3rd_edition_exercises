...
template <size_t N>
void color_each(Vector_ref<Regular_hexagon>& vec, const std::array<Color, N>& colors) {
    if (colors.empty())
...
int main(int /*argc*/, char * /*argv*/[])
{
    ...
    const std::string label = "Hexagon tiling with colors";
    ...
    const std::array<Color, 7> colors = {{
        Color::blue, Color::dark_blue, Color::cyan, Color::yellow,
        Color::dark_red, Color::green, Color::dark_yellow
    }};
    color_each(vec, colors);
